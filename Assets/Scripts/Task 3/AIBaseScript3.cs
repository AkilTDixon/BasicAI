...
public class AIBaseScript3 : MonoBehaviour
{
    public enum AIType
    {
        Hero,
    ...
    void Update()
    {
        if (type == AIType.Hero || type == AIType.Prisoner)
        {
            ...
            if (target)
            {
                ...
                if (type == AIType.Hero)
                {
                    ...
                    HeroScript3 hs = GetComponent<HeroScript3>();
                    ...
                    if (!hs.victory)
                    {
                        if (hs.detected)
                        {
                            ...
                            else if (strat == Strategy.Destroy)
                            {
                                ...
                                {
                                    sp = closestGuardian.gameObject.GetComponent<AIBaseScript3>().maxSpeed;
        ...
        {
            GuardianScript3 gs = GetComponent<GuardianScript3>();

            targetPath = gs.GetTargetPath() - Velocity;
