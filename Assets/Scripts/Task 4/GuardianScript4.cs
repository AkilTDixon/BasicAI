...
public class GuardianScript4 : MonoBehaviour
{
    ...
    [SerializeField] public AIBaseScript4 agent;
    ...
    void Start()
    {
        maxSpeed = GetComponent<AIBaseScript4>().maxSpeed;
        captureRadius = radius / 4f;
        hs = HeroObject.GetComponent<HeroScript4>();
