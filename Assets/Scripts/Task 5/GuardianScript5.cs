...
public class GuardianScript5 : MonoBehaviour
{
    ...
    [SerializeField] public AIBaseScript5 agent;
    ...
    void Start()
    {
        maxSpeed = GetComponent<AIBaseScript5>().maxSpeed;
        captureRadius = radius / 4f;
        hs = HeroObject.GetComponent<HeroScript5>();
    ...
    public void BaseHit()
    {
        ...
        {
            hs.detected = false;
            if (hs.strat == HeroScript5.Strategy.Hunt)
