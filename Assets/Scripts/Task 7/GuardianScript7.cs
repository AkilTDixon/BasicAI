...
public class GuardianScript7 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        maxSpeed = GetComponent<AIBaseScript7>().maxSpeed;
        captureRadius = radius / 4f;
        hs = HeroObject.GetComponent<HeroScript7>();
