...
public class GuardianScript8 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        maxSpeed = GetComponent<AIBaseScript8>().maxSpeed;
        captureRadius = radius / 4f;
        hs = HeroObject.GetComponent<HeroScript8>();
