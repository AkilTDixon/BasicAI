...
public class HeroScript8 : MonoBehaviour
{
    ...
    [SerializeField] public AIBaseScript8 agent;
    ...
    public void OnCollisionEnter(Collision collision)
    {
        ...
        {
            GameInfoScript.Instance.GameOver("Task 8");
        }
    }
    public void OnTriggerEnter(Collider other)
    {
        ...
        {
            other.GetComponent<PrisonerScript8>().Follow();
    ...
    {
        h = new Helper();
        pf = GetComponent<PathfinderScript8>();
        ...
        if (rangeChecks.Length != 0)
        {
            ...
            if (visible.Count > 0)
            {
                ...
                if (!Physics.Raycast(transform.position, direction, dist, agent.blockedMask))
                {
                    ...
                    GuardianScript8 gs = visible[index].GetComponent<GuardianScript8>();
