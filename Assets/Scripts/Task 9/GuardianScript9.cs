...
public class GuardianScript9 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        maxSpeed = GetComponent<AIBaseScript9>().maxSpeed;
...
/*            }
            ...
            {*/
                ...
                hs = visibleHeroes[index].GetComponent<HeroScript9>();
